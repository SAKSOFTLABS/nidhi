          ...
          <!-- <div class="content-wrapper"> -->
            ...
            <!-- <div class="container-xxl flex-grow-1 container-p-y"> -->
              <!-- Layout Demo -->
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Registration /</span> Share Holder</h4>
                      <div class="demo-inline-spacing">
                      <!-- <a href="../soft/add-shareholder.php" class="btn btn-primary">Add Share Holder</a> -->
                      <a href="#" class="btn btn-primary" onclick="addShareholder()" id="addshare">Add Share Holder</a>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel3">Edit Share Holder</h5>
                              <button
                                type="button"
                                class="btn-close"
                    ...
                    <div class="modal fade" id="smallModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-sm" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel2">Delete Share Holder</h5>
                              <button
                                type="button"
                                class="btn-close"
                                data-bs-dismiss="modal"
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                  <label for="nameSmall" class="form-label">Enter security key to delete this share holder.</label>
              ...
              <div class="card">
                <h5 class="card-header">Share Holder List</h5>
            ...
            <script>
              function addShareholder2(){
                $("#main").load("add-shareholder.php");
              }
                let fetchBtn = document.getElementById('addshare');
                ...
                function addShareholder() {
                    ...
                    xhr.open('GET', 'add-shareholder.php');
