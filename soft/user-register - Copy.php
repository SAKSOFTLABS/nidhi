...
<?php include('user-header.php'); ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <!-- Layout Demo -->
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Registration /</span> Users</h4>
                      <div class="demo-inline-spacing">
                      <a href="../soft/add-user.php" class="btn btn-primary">Add User</a>
                    ...
                    <div class="modal fade" id="smallModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-sm" role="document">
                          <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                  <label for="nameSmall" class="form-label">Enter security key to delete this user.</label>
