          ...
          <!-- <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y"> -->
              <!-- Layout Demo -->
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Registration /</span> Fixed & Savings Deposit</h4>
                      <div class="demo-inline-spacing">
                      <a href="#" class="btn btn-primary" onclick="addDeposit()">Add Deposit</a>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel3">Edit Deposit</h5>
                              <button
                                type="button"
                                class="btn-close"
                    ...
                    <div class="modal fade" id="smallModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-sm" role="document">
                          <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                  <label for="nameSmall" class="form-label">Enter security key to delete this deposit.</label>
